...
export const ApiPublicSchema = {
    ...
    type: 'object',
    required: ['id', 'group', 'name', 'path', 'method'],
    title: 'ApiPublic'
} as const;

export const ApiTreeNodeSchema = {
    properties: {
        key: {
            type: 'string',
            title: 'Key'
        ...
        children: {
            items: {
                '$ref': '#/components/schemas/ApiTreeNode'
            },
            type: 'array',
            title: 'Children',
            default: []
...
export const ApiTreePublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/ApiTreeNode'
...
export const ApplicationPrivateSchema = {
    ...
    type: 'object',
    required: ['id', 'name', 'is_active', 'app_id', 'app_key'],
...
export const ApplicationPublicSchema = {
    ...
    type: 'object',
    required: ['id', 'name', 'is_active', 'app_id'],
...
export const MenuTreeNodeSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
...
export const TaskStatusSchema = {
    type: 'string',
    enum: ['pending', 'running', 'success', 'failed', 'revoked', 'disabled'],
    title: 'TaskStatus',
    description: '任务状态'
} as const;
